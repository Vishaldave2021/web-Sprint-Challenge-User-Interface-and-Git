...
1. If you were to describe semantic HTML to the next cohort of students, what would you say? Semantic Html is the use of HTML markup to reinforce the semantics, or meaning, of the information in webpages and web applications rather than merely to define its presentation or look.

2. Name two big differences between ```display: block;``` and ```display: inline;```
display: inline-block allows to set a width and height on the element display: block doesn't.

display: inline-block does not add a line-break after the element, so the element can sit next to other elements display: block starts new line.
...
Git is valuable because it allows a team to work, collaborate and commit changes on a project also it allows you to go back and undo and make changes.
